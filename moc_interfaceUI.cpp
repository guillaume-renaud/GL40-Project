/****************************************************************************
** Meta object code from reading C++ file 'interfaceUI.h'
**
...
#include "include/interfaceUI.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'interfaceUI.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Ui_MainWindow_t, stringdata) + ofs \
...
const QMetaObject Ui_MainWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Ui_MainWindow.data,
      qt_meta_data_Ui_MainWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ui_MainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ui_MainWindow.stringdata))
